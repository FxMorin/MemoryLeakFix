...
/**
 * This code was extracted from <a href="https://github.com/LlamaLad7/MixinExtras/blob/master/src/main/java/com/llamalad7/mixinextras/utils/MixinInternals.java">MixinExtras</a>
 */
...
public class MixinInternals {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to access some mixin internals, please report to FX!", e);
        }
    }
    ...
    public static List<Pair<IMixinInfo, ClassNode>> getMixinsFor(ITargetClassContext context) {
        try {
            ...
            throw new RuntimeException("Failed to use mixin internals, please report to FX!", e);
        }
    }
